...
void GUI::PrintMessage(string msg,int c) const	//Prints a message on status bar
{
	...
	if (c==0)
	{ClearStatusBar();
	pWind->DrawString(10, WindHeight - (int) (StatusBarHeight-5), msg);
	}// You may need to change these coordinates later 
	if (c==1)
		pWind->DrawString(10, WindHeight - (int) (StatusBarHeight-25), msg);  // to be able to write multi-line
	if (c==2)
		pWind->DrawString(10, WindHeight - (int) (StatusBarHeight-58), msg);
	if (c==3)
		pWind->DrawString(10, WindHeight - (int) (StatusBarHeight-92), msg);
	if (c==4)
		pWind->DrawString(10, WindHeight - (int) (StatusBarHeight-125), msg);
	if (c==5)
		pWind->DrawString(10, WindHeight - (int) (StatusBarHeight-42), msg);
	if (c==6)
		pWind->DrawString(10, WindHeight - (int) (StatusBarHeight-76), msg);
	if (c==7)
		pWind->DrawString(10, WindHeight - (int) (StatusBarHeight-109), msg);
	if (c==8)
		pWind->DrawString(10, WindHeight - (int) (StatusBarHeight-139), msg);
}
//////////////////////////////////////////////////////////////////////////////////////////
